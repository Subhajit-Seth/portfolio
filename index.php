        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 py-6 pb-0 pt-lg-0">
                    <h2 class="text-primary mb-3">I'm</h2>
                    <h1 class="display-3 mb-3">Subhajit Seth</h1>
                    ...
                    <div class="d-flex align-items-center pt-5">
                        <a href="download.php" class="btn btn-primary py-3 px-4 me-5">Download CV</a>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="skill mb-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="font-weight-bold">REST API</h6>
                                    <h6 class="font-weight-bold">95%</h6>
                                </div>
                                <div class="progress">
                                    <div class="progress-bar bg-info" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">
        ...
        <div class="container py-5">
            ...
            <div class="row g-5">
                <div class="col-lg-5 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h3 class="fw-bold">+916295369020</h3>
                    <hr class="w-100">
                    <p class="mb-2">Mail me:</p>
                    <h3 class="fw-bold">subhajitseth1998@gmail.com</h3>
                    <hr class="w-100">
                    <p class="mb-2">Follow me:</p>
                    <div class="d-flex pt-2">
                        <a class="btn btn-square btn-primary me-2" href="https://x.com/Subhajit_Sy8"><i class="fab fa-twitter"></i></a>
                        <a class="btn btn-square btn-primary me-2" href="https://www.facebook.com/subhajit.seth.2025"><i class="fab fa-facebook-f"></i></a>
                        <!-- <a class="btn btn-square btn-primary me-2" href=""><i class="fab fa-youtube"></i></a> -->
                        <a class="btn btn-square btn-primary me-2" href="https://www.linkedin.com/in/subhajit-seth-9511ab160/"><i class="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center mb-3 mb-md-0">Copyright 
                        &copy; <?php echo date("Y"); ?><a class="border-bottom text-secondary" href="#"> <?php
                        echo $_SERVER['SERVER_NAME']; ?>    </a>, All Right Reserved
                    </div>
                </div>
            </div>
        </div>
